...
RUN_LABEL="sft_v6_3_e4b_g6e_qlora_seed42"
CKPT_REPO="voidash/gemma-helpdesk-v6-3-e4b-g6e-qlora-seed42"
...
cleanup() {
  ...
  hf upload --repo-type model --token "$HF_TOKEN" "$CKPT_REPO" /home/ubuntu/train_v6_3_g6e_qlora.log train_v6_3_g6e_qlora.log
  hf upload --repo-type model --token "$HF_TOKEN" "$CKPT_REPO" /home/ubuntu/eval_v6_3_g6e_qlora.log eval_v6_3_g6e_qlora.log
  echo "=== exit rc=$rc $(date -u +%FT%TZ) ===" | tee -a /home/ubuntu/done_v6_3_g6e_qlora.log
  sudo shutdown -h now
  exit "$rc"
}
trap cleanup EXIT
...
} 2>&1 | tee -a /home/ubuntu/train_v6_3_g6e_qlora.log
...
} 2>&1 | tee -a /home/ubuntu/eval_v6_3_g6e_qlora.log

echo "=== all done $(date -u +%FT%TZ) ===" | tee -a /home/ubuntu/done_v6_3_g6e_qlora.log
